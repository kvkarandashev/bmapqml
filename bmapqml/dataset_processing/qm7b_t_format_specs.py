...
class Quantity_diff:
    ...
    def OML_calc_quant(self, xyz_name, **oml_calc_kwargs):
        return self.quant2.OML_calc_quant(
            xyz_name, **oml_calc_kwargs
        ) - self.quant1.OML_calc_quant(xyz_name, **oml_calc_kwargs)
