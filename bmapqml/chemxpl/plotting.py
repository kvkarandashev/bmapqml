...
class Analyze:
    ...
    def parse_results(self):
        ...
        if self.mode == "optimization":
            self.DIPOLE, self.GAP = self.GLOBAL_HISTOGRAM["Dipole"].values, self.GLOBAL_HISTOGRAM["HOMO_LUMO_gap"]
    ...
    def plot_pareto(self, hline=None, vline=None ):
       ...
       # coloring = HISTOGRAM["ENCONTER"].values
        ...
        for simplex in self.hull.simplices:
            plt.plot(self.points[simplex, 0], self.points[simplex, 1], 'o-', color="black")
