...
optimized_hyperparams=stochastic_gradient_descent_hyperparam_optimization(training_reps, training_quants,
                    init_param_guess=np.array([1.0, 100.0]), max_stagnating_iterations=8,
                    randomized_iterator_kwargs={"default_step_magnitude" : 0.05}, sym_kernel_func=gaussian_sym_kernel_matrix)
