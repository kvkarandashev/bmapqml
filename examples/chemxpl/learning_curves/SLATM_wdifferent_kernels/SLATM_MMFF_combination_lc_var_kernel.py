...
from bmapqml.fkernels import gaussian_kernel_matrix, gaussian_sym_kernel_matrix, laplacian_kernel_matrix, laplacian_sym_kernel_matrix
...
KRR_model=KRR(init_sigma_guess_func=init_sigma_guess_func, kernel_function=kernel_matrix, sym_kernel_function=sym_kernel_matrix)
