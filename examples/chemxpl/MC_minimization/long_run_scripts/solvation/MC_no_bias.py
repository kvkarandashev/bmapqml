...
xyz_dir = os.environ["DATA"] + "/QM9_formatted"

xyzs = dirs_xyz_list(xyz_dir)
...
while True:
    ...
    init_egcs = []
    for f in random.sample(xyzs, num_replicas):
        ...
        try:
            ...
            init_egcs.append(None)
            break
    if None in init_egcs:
        continue
    try:
