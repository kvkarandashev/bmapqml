...
dump_directory="/store/konst/chemxpl_related/minimization_runs_xTB_dipole_solvation_cheap_post_sub"
...
py_script=$cur_directory/MC_opt_post_sub_3.py
...
valid_starter_strs=$cur_directory/qm9_compliant_str_valid_evals.txt
