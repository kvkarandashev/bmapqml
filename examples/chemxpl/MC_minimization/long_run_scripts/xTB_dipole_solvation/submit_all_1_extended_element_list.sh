...
py_script=$cur_directory/MC_opt_1_extended_element_list.py
...
do
    ...
    do
        ...
        do
            ...
            for seed in $(seq 1 8)
            do
                spython --OMP_NUM_THREADS=1 --CPUs=1 $py_script ${cur_job_name}_$seed $min_func_file $quantity $seed $bias_strength
            done
            cd $cur_directory
        done
    done
