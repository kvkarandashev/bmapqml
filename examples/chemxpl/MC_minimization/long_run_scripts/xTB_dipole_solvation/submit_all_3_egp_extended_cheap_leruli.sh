...
dump_directory="/store/konst/chemxpl_related/minimization_runs_xTB_dipole_solvation_cheap_leruli"
...
common_flags="--memory=$((NCPUs*10000)) --CPUs=$NCPUs --OMP_NUM_THREADS=1 --export_env_vars=MORFEUS_NUM_THREADS=$NCPUs/OMP_NUM_THREADS=$((NCPUs/2)),1/OMP_MAX_ACTIVE_LEVELS=1 --update_bmapqml"
...
do
    ...
    do
        ...
        do
            ...
            min_func_file=$cur_directory/egp_morfeus_xTB_cheap_water_${quantity}_${gap_constraint}.pkl
            ...
            do
                ...
                lpython $common_flags --req_files=$req_files $py_script $seed_name $(basename $min_func_file) min_$quantity $seed $bias_strength
            done
            cd $cur_directory
        done
    done
