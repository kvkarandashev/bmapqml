...
# It is defined as chemical space of up to 5 heavy atoms (C, P, or S), with S not protonated, and P-P and S-S covalent bonds forbidden.
chemspace_def = {
    ...
    "possible_elements": ["C", "P", "S"],  # allowed elements
